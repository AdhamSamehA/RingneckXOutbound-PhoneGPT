...
HTTP_SERVER_PORT : int = 3000 # Assuming HTTP port of choice is 3000
NGROK_HTTPS_URL : str = ''
...
# Dictionary for generic fillers - used for the play_random_filler method
LABEL_TO_GENERIC_LABEL = {
    'generic-1' : f"{AGENT_AUDIO_FOLDER}/generic-1-filler.wav",
    'generic-2' : f"{AGENT_AUDIO_FOLDER}/generic-2-filler.wav",
    'generic-3' : f"{AGENT_AUDIO_FOLDER}/generic-3-filler.wav",
    'generic-4' : f"{AGENT_AUDIO_FOLDER}/generic-4-filler.wav",
    'generic-5' : f"{AGENT_AUDIO_FOLDER}/generic-5-filler.wav",
    'generic-6' : f"{AGENT_AUDIO_FOLDER}/generic-6-filler.wav",
    'generic-7' : f"{AGENT_AUDIO_FOLDER}/generic-7-filler.wav",
}
